                        ...
                        <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
                            ...
                            <div className="text-lg leading-8">
                                <p>
                                    ...
                                    <span className="bg-slate-800 p-0.5 text-white">the image is super clear</span>, on
            ...
            <section>
                <MaxWidthWrapper className="py-24">
                    ...
                    <ul className="mx-auto mt-12 w-fit max-w-prose space-y-2 sm:text-lg">
                        ...
                        <li className="w-fit">
                            <Check className="mr-1.5 inline h-5 w-5 text-green-600" />5 year print warranty
                        </li>
